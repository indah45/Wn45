...
kr9 = CBW.LINE()
#kr9.login(qr=True)
kr9.login(token="Ep07zQEWTPjQOyKlxV97.6Y0z8Cdtymvu1mBZSliFvW.hdm7TnRBEHho0YuE++SifY78jWWS8BG7UeLfRG0CiLc=")#9
kr9.loginResult()
...
KAC=[wN1,wN2,wN3,wN4,wN5,wN6,wN7,wN8,kr9,wN10]
            ...
            if op.param3 in mid7:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  G.preventJoinByTicket = False
                  kr9.updateGroup(G)
                  Ticket = kr9.reissueGroupTicket(op.param1)
            ...
            if op.param3 in mid9:
              if op.param2 not in Bots or admin:
                try:
                  ...
                  kr9.acceptGroupInvitationByTicket(op.param1,Ticket)
                  time.sleep(0.01)
                  G.preventJoinByTicket = True
                  kr9.updateGroup(G)
                  wait["blacklist"][op.param2] = True
                ...
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ...
                        try:
                            ...
                            kr9.sendText(msg.to,"Bye~Bye " + str(ginfo.name) + "\n\nJangan Lupa Bahagia...!!!")
            ...
            if op.param3 in mid: 
                if op.param2 in owner: 
                    try: 
                        ...
                        kr9.acceptGroupInvitation(op.param1,Ti) 
            ...
            try:
                if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Name = kr9.getContact(op.param2).displayName
