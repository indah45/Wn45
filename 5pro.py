...
wN1 = CBW.LINE()
#wN1.login(qr=True)
wN1.login(token="Epxfhuif8NZKTeE6FEid.FyVRtKEBLFEuaU36x7sO3q.zcaRmc4hwbfSWN2Mfjrrjii1tIt7Psr2n4C2vyVos9k=")#1
wN1.loginResult()

wN2 = CBW.LINE()
#wN2.login(qr=True)
wN2.login(token="Ep7VzXde1cojIWATuQda.00XSIVYDkUfkAzZrR4UzYG.p9pHDTGzraktsEQvyT9Z1BV8XpyOgkH2RI3Kc/JObN0=")#2
wN2.loginResult()

wN3 = CBW.LINE()
#wN3.login(qr=True)
wN3.login(token="EpOhV0ioHMDpdZ51XJ0e.MGPgtY0Gwcc0Q7kVqfPgtG.D5NnveMkZoLOFO258TxEfB5miUedrYJCkLiTldn2IOM=")#3
wN3.loginResult()

wN4 = CBW.LINE()
#wN4.login(qr=True)
wN4.login(token="EpinftLoJAoWdLrbdf87.L1mYXPq7tk5jIxn4GditXW.MHkouGpChvtzFxOJ3ysDr3pfTv5UOTpePhVKPffN+i8=")#4
wN4.loginResult()

wN5 = CBW.LINE()
#wN5.login(qr=True)
wN5.login(token="Epssh8LRCA13pJayrYD5.nldM1B6yM6kQXJdxg2Ikfq.WC4WnVSPFTYkEei2XhLghIf78b3jRzkZLb7aS87/23U=")#5
wN5.loginResult()
...
#==============================================================================#
            ...
            elif "4bye" in msg.text:#keluar semua bots
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ginfo = wN1.getGroup(msg.to)
