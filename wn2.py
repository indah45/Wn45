...
wN = CBW.LINE()
#wN.login(qr=True)
wN.login(token='EpS0tmC0ZTDhKOGiKDmb.fpzoe5O4f6/QVIFsn6/ZAW.l+ZRTs/GX3nkrHE/Y77Huo1aF65/TOARxV8ppihfEOQ=')
wN.loginResult()
print "wN-Login Success\n\n=====[Sukses Login]====="
...
╚═════════════════════════
"""
tjia="uc301fa8f0962f52b1f2d83dc251589cb"
...
Bots=[mid]
Creator=["uc301fa8f0962f52b1f2d83dc251589cb"]
admin=["uc301fa8f0962f52b1f2d83dc251589cb"]

contact = wN.getProfile()
backup1 = wN.getProfile()
backup1.displayName = contact.displayName
backup1.statusMessage = contact.statusMessage                        
backup1.pictureStatus = contact.pictureStatus

responsename = wN.getProfile().displayName
...
#                            Name = summon(op.param2)
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        wN.sendText(op.param1, "Haii " + "☞ " + Name + " ☜" + "\nNgintip Aja Niih. . .\nChat Kek Idiih (-__-)   ")
                                        time.sleep(0.2)
	    ...
	    if mid in op.param3:	        
		    ...
		    G = wN.getGroup(op.param1)
                    if len(G.members) <= wait["memberscancel"]:
                        wN.acceptGroupInvitation(op.param1)
                        wN.sendText(op.param1,"Maaf " + wN.getContact(op.param2).displayName + "\nMember Kurang Dari 30 Orang\nUntuk Info, Silahkan Chat Owner Kami!")
                        wN.leaveGroup(op.param1)                        
		    else:
                        wN.acceptGroupInvitation(op.param1)
			wN.sendText(op.param1,"☆Ketik ☞Help☜ Untuk Bantuan☆\n☆Harap Gunakan Dengan Bijak ^_^ ☆")
	    ...
	    if mid in op.param3:
			...
			wN.cancelGroupInvitation(op.param1, [op.param3])
			wN.sendText(op.param1, "Blacklist Detected")
		    else:
			pass
        ...
        if op.type == 17:
          if wait["Sambutan"] == True:
            ...
            wN.sendText(op.param1,"Hallo " + wN.getContact(op.param2).displayName + "\nWelcome To ☞ " + str(ginfo.name) + " ☜" + "\nBudayakan Cek Note\nDan Semoga Betah Disini ^_^")
            c = Message(to=op.param1, from_=None, text=None, contentType=13)
            c.contentMetadata={'mid':op.param2}
            wN.sendMessage(c)  
            wN.sendImageWithURL(op.param1,image)
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in Creator:
                return
            wN.sendText(op.param1,"Good Bye " + wN.getContact(op.param2).displayName +  "\nSee You Next Time . . . (p′︵‵。) 🤗")
            d = Message(to=op.param1, from_=None, text=None, contentType=7)
            d.contentMetadata={
                                    "STKID": "13269542",
                                    "STKPKGID": "1329191",
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                wN.sendText(msg.to,data['result']['response'].encode('utf-8'))
          ...
          if wait["Bot"] == True:    
            ...
            if msg.contentType == 16:
                if wait['likeOn'] == True:
                     ...
                     wN.like(url[25:58], url[66:], likeType=1005)
                     wN.comment(url[25:58], url[66:], wait["comment"])
                     wN.sendText(msg.to,"Like Success")                     
                     wait['likeOn'] = False
		    ...
		    if msg.contentMetadata["mid"] not in admin:
                        if msg.contentMetadata["mid"] in wait["blacklist"]:
                            wN.sendText(msg.to,"Sudah")
                            wait["wblacklist"] = False
                        else:
                            wait["blacklist"][msg.contentMetadata["mid"]] = True
                            wait["wblacklist"] = False
                            wN.sendText(msg.to,"Ditambahkan")
		    else:
			wN.sendText(msg.to,"Admin Detected~")
			

                elif wait["dblacklist"] == True:
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        del wait["blacklist"][msg.contentMetadata["mid"]]
                        wN.sendText(msg.to,"Terhapus")
                        wait["dblacklist"] = False

                    else:
                        wait["dblacklist"] = False
                        wN.sendText(msg.to,"Tidak Ada Black List")
                ...
                wN.sendMessage(msg)
		wN.sendText(msg.to,"Itu Majikan Kami (^_^)")
		...
		gCreator = ginfo.creator.mid
                ...
                wN.sendMessage(msg)
		wN.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            if msg.contentType == 13:
                ...
                wN.sendText(msg.to,creatorMessage)

            elif msg.text in ["Key group","help group","Help group"]:
                wN.sendText(msg.to,groupMessage)

            elif msg.text in ["Key","help","Help"]:
                wN.sendText(msg.to,helpMessage)

            elif msg.text in ["Key self","help self","Help self"]:
                wN.sendText(msg.to,selfMessage)

            elif msg.text in ["Key bot","help bot","Help bot"]:
                wN.sendText(msg.to,botMessage)

            elif msg.text in ["Key set","help set","Help set"]:
                wN.sendText(msg.to,setMessage)

            elif msg.text in ["Key media","help media","Help media"]:
                wN.sendText(msg.to,mediaMessage)
                
            elif msg.text in ["Key admin","help admin","Help admin"]:
                wN.sendText(msg.to,adminMessage)               
		...
		if msg.from_ in admin:
			...
			if h == grp:
			    wait["BlGroup"][i]=True
			    wN.sendText(msg.to, "Success Ban Group : "+grp)
			else:
			    pass
		else:
		    wN.sendText(msg.to, "Khusus wN")
 
            elif msg.text in ["List ban","List ban group"]:
		if msg.from_ in admin:
                    if wait["BlGroup"] == {}:
                        wN.sendText(msg.to,"Tidak Ada")
                    else:
                        mc = ""
                        for gid in wait["BlGroup"]:
                            mc += "-> " +wN.getGroup(gid).name + "\n"
                        wN.sendText(msg.to,"===[Ban Group]===\n"+mc)
		else:
		    wN.sendText(msg.to, "Khusus Admin")
 
	    elif msg.text in ["Del ban: "]:
		if msg.from_ in admin:
		    ng = msg.text.replace("Del ban: ","")
		    for gid in wait["BlGroup"]:
		        if wN.getGroup(gid).name == ng:
			    del wait["BlGroup"][gid]
			    wN.sendText(msg.to, "Success del ban "+ng)
		        else:
			    pass
		else:
		    wN.sendText(msg.to, "Khusus wN")
		...
		try:
		    if msg.from_ in Creator:
                        for i in gid:
                            h = wN.getGroup(i).name
		            if h == ng:
		                wN.inviteIntoGroup(i,[Creator])
			        wN.sendText(msg.to,"Success Join To ["+ h +"] Group")
			    else:
			        pass
		    else:
		        wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = wN.getGroup(i).name
		        if h == ng:
			    wN.sendText(i,"Bot Di Paksa Keluar Oleh Owner!")
		            wN.leaveGroup(i)
		...
		gid = wN.getGroupIdsJoined()
			...
			wN.sendText(i,"Bot Di Paksa Keluar Oleh Owner!")
		        wN.leaveGroup(i)
		    wN.sendText(msg.to,"Success Leave All Group")
		else:
		    wN.sendText(msg.to,"Khusus wN")
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        wN.sendText(msg.to,"Tidak Ada Yang Pending")
                else:
                    wN.sendText(msg.to,"Tidak Bisa Digunakan Diluar Group")
                ...
                if msg.toType == 2:
                    ...
                    wN.updateGroup(X)
                    wN.sendText(msg.to,"Url Sudah Aktif")
                else:
                    wN.sendText(msg.to,"Can not be used outside the group")
                ...
                if msg.toType == 2:
                    ...
                    wN.updateGroup(X)
                    wN.sendText(msg.to,"Url Sudah Di Nonaktifkan")
		...
		if msg.from_ in admin:
                    ...
                    wN.sendText(msg.to,"Auto Join Sudah Aktif")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    wait["AutoJoin"] = False
                    wN.sendText(msg.to,"Auto Join Sudah Di Nonaktifkan")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    ...
                    wait["AutoJoin"] = False
                    wN.sendText(msg.to,"Auto Join Cancel Sudah Aktif")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    wait["AutoJoinCancel"] = False
                    wN.sendText(msg.to,"Auto Join Cancel Sudah Di Nonaktifkan")
		else:
		    wN.sendText(msg.to,"Khusus wN")		    
		...
		if msg.from_ in admin:
                    ...
                    wN.sendText(msg.to,"Auto Respon1 Sudah Aktif")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    ...
                    wN.sendText(msg.to,"Auto Respon1 Sudah Off")
		else:
		    wN.sendText(msg.to,"Khusus wN")	
		...
		if msg.from_ in admin:
                    ...
                    wait["detectMention3"] = False
                    wait["kickMention"] = False
                    wN.sendText(msg.to,"Auto Respon2 Sudah Aktif")
		else:
		    wN.sendText(msg.to,"Khusus wN")
            elif msg.text in ["Respon2 off"]:
		if msg.from_ in admin:
                    wait["detectMention2"] = False
                    wN.sendText(msg.to,"Auto Respon2 Sudah Off")
		else:
		    wN.sendText(msg.to,"Khusus wN")	
		...
		if msg.from_ in admin:
                    ...
                    wait["kickMention"] = False
                    wN.sendText(msg.to,"Auto Respon3 Sudah Aktif")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    wait["detectMention3"] = False
                    wN.sendText(msg.to,"Auto Respon3 Sudah Off")
		else:
		    wN.sendText(msg.to,"Khusus wN")	
		...
		if msg.from_ in admin:
                    ...
                    wait["detectMention2"] = False
                    wait["detectMention3"] = False                    
                    wN.sendText(msg.to,"Auto Respon Kick Sudah Aktif")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    wait["kickMention"] = False                    
                    wN.sendText(msg.to,"Auto Respon Kick Sudah Off")
		else:
		    wN.sendText(msg.to,"Khusus wN")			  
	     ...
	     if msg.from_ in admin:	        
                ...
                wN.sendText(msg.to,"Auto Cancel Sudah Aktif")
		print wait["AutoCancel"]
	     ...
	     if msg.from_ in admin:	        
                ...
                wN.sendText(msg.to,"Auto Cancel Sudah Di Nonaktifkan")
		print wait["AutoCancel"]
	     else:
		    wN.sendText(msg.to,"Khusus wN")	
	     ...
	     if msg.from_ in admin:	        
                ...
                wN.sendText(msg.to,"Invite Protect Sudah Aktif")
		print wait["inviteprotect"]
	     ...
	     if msg.from_ in admin:	        
                ...
                wN.sendText(msg.to,"Invite Protect Sudah Di Nonaktifkan")
		print wait["inviteprotect"]
	     else:
		    wN.sendText(msg.to,"Khusus wN")		    
	     ...
	     if msg.from_ in admin:	        
	        wait["Qr"] = True
	    	wN.sendText(msg.to,"QR Protect Sudah Aktif")
	     else:
		    wN.sendText(msg.to,"Khusus wN")	    	
	     ...
	     if msg.from_ in admin:	        
	    	wait["Qr"] = False
	    	wN.sendText(msg.to,"Qr Protect Sudah Di Nonaktifkan")
	     else:
		    wN.sendText(msg.to,"Khusus wN")	    	
	     ...
	     if msg.from_ in admin:	 	        
		     wait["AutoKick"] = True
		     wN.sendText(msg.to,"Auto Kick Sudah Aktif")
	     else:
	        wN.sendText(msg.to,"Khusus wN")	     
	     ...
	     if msg.from_ in admin:	 	        
		     wait["AutoKick"] = False
		     wN.sendText(msg.to,"Auto Kick Sudah Di Nonaktifkan")
	     else:
	        wN.sendText(msg.to,"Khusus wN")	     
		...
		if msg.from_ in admin:
                    ...
                    wait["AutoKick"] = True
                    wait["Qr"] = True
                    wN.sendText(msg.to,"All Protect Sudah Aktif Semua")
		else:
		    wN.sendText(msg.to,"Khusus wN")
		...
		if msg.from_ in admin:
                    ...
                    wait["AutoKick"] = False
                    wait["Qr"] = False
                    wN.sendText(msg.to,"All Protect Sudah Di Nonaktifkan Semua")
		else:
		    wN.sendText(msg.to,"Khusus wN")
                ...
                wait["Contact"] = True
                wN.sendText(msg.to,"Contact Sudah Aktif")

            elif msg.text in ["K off","Contact off"]:
                wait["Contact"] = False
                wN.sendText(msg.to,"Contact Sudah Di Nonaktifkan")
                

            elif msg.text in ["Alwaysread on"]:
                wait["alwaysRead"] = True
                wN.sendText(msg.to,"Always Read Sudah Aktif")

            elif msg.text in ["Alwaysread off"]:
                wait["alwaysRead"] = False
                wN.sendText(msg.to,"Always Read Sudah Di Nonaktifkan")                
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    if len(dataResult) > 0:
                        ...
                        subprocess.Popen("echo '' > dataSeen/"+msg.to+".txt", shell=True, stdout=subprocess.PIPE)
                        wN.sendText(msg.to, "☆Auto Checkpoint☆")                        
                    else:
		...
		if msg.from_ in admin:	        
		    if 'MENTION' in msg.contentMetadata.keys()!= None:
		        ...
		        print mentionees
		        for mention in mentionees:
			    wN.kickoutFromGroup(msg.to,[mention['M']])

	    elif "Set member: " in msg.text:
		if msg.from_ in admin:	 	        
		    jml = msg.text.replace("Set member: ","")
		    wait["Members"] = int(jml)
		    wN.sendText(msg.to, "Jumlah minimal member telah di set : "+jml)
		    ...
		    wN.sendText(msg.to,"Success Add all")
                ...
                wait["likeOn"] = True
                wN.sendText(msg.to,"Shere Post Kamu Yang Mau Di Like!")                
		...
		Mids = [contact.mid for contact in thisgroup[0].members]
		mi_d = Mids[:33]
		wN.createGroup("Recover", mi_d)
		wN.sendText(msg.to,"Success recover")
		...
		if midd not in admin:
		    ...
		    wN.sendText(msg.to,"Admin Detected")
                ...
                midd = "uc301fa8f0962f52b1f2d83dc251589cb"
                wN.inviteIntoGroup(msg.to,[midd])

            elif msg.text in ["Welcome","welcome","Welkam","welkam","Wc","wc"]:
                gs = wN.getGroup(msg.to)
                wN.sendText(msg.to,"Selamat Datang Di "+ gs.name)
                msg.contentType = 7
		...
		if msg.from_ in Creator:
		    ...
		    wN.sendText(msg.to,"Success BC BosQ")
		else:
		    wN.sendText(msg.to,"Khusus Admin")
		...
		try:
                    url = wN.activity(limit=5)
		    wN.sendText(msg.to,url['result']['posts'][0]['postInfo']['postId'])
		except Exception as E:
		    print E
		...
		wN.sendText(msg.to,"Hadir!!")


            elif msg.text.lower() in ["respon"]:
                wN.sendText(msg.to,responsename)

            elif msg.text in ["Sp","Speed","speed"]:
                start = time.time()
                print("Speed")                
                elapsed_time = time.time() - start
		wN.sendText(msg.to, "Progress...")
			    ...
			    if target not in admin:
                                try:
                                    ...
                                    wN.sendText(msg.to,"Succes BosQ")
                                except:
              ...
              if msg.from_ in admin:
                if wait["blacklist"] == {}:
                    ...
                    wN.sendText(msg.to,"===[Blacklist User]===\n"+mc)
                ...
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    wN.sendText(msg.to,"ヽ( ^ω^)ﾉ└ ❉Unbanned All Success❉ ┐") 
		...
		if msg.from_ in admin:
                    if msg.toType == 2:
                        ...
                        if matched_list == []:
                            wN.sendText(msg.to,"There was no blacklist user")
                            return
                        for jj in matched_list:
                            wN.kickoutFromGroup(msg.to,[jj])
                        wN.sendText(msg.to,"Blacklist emang pantas tuk di usir")
		else:
		    wN.sendText(msg.to, "Khusus creator")
		    ...
		    if msg.from_ in Creator:
				...
				if target not in admin:
                                    try:
                                        ...
                                        wN.sendText(msg.to,str(e))
			    wN.inviteIntoGroup(msg.to, targets)
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                try:
                    wN.updateDisplayPicture(backup1.pictureStatus)
                    wN.updateProfile(backup1)
                    wN.sendText(msg.to, "Done (^_^)")
                except Exception as e:
                    wN.sendText(msg.to, str(e))
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                h = wN.channel.getHome(target)
                                objId = h["result"]["homeInfo"]["objectId"]
                                wN.sendImageWithURL(msg.to,"http://dl.profile.line-cdn.net/myhome/c/download.nhn?userid=" + target + "&oid=" + objId)
                            except Exception as error:
                                print error
                                wN.sendText(msg.to,"Upload image failed.")
                ...
                if msg.from_ in admin:
                    path = "wN.jpg"
                    wN.sendText(msg.to,"Update PP :")
                    wN.sendImage(msg.to,path)
                    wN.updateProfilePicture(path)                                
                ...
                if msg.toType == 2:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                wN.sendImageWithURL(msg.to,pilih)
                  ...
                  t = 10
                  while(t):
                    wN.sendText(msg.to, (bctxt))
                    t-=1

            elif "Scbc " in msg.text:
                  bctxt = msg.text.replace("Scbc ", "")
                  orang = wN.getAllContactIds()
                  t = 20
                  ...
                  orang = wN.getAllContactIds()
                  for manusia in orang:
                    wN.sendText(manusia, (broadcasttxt))
                    ...
                    for count in range(1, 999):
                        ...
                        for node in j['entry_data']['ProfilePage'][0]['user']['media']['nodes']: 
                            if node['is_video']:
                                ...
                                print(url)
                                wN.sendVideoWithURL(msg.to,url)
                            else:
                                print (node['display_src'])
                                wN.sendImageWithURL(msg.to,node['display_src'])
                ...
                try:
                    ...
                    wN.sendText(msg.to,'https://www.youtube.com' + results['href'])
                except:
                    ...
                    try:
                        ...
                        soup = BeautifulSoup(html, "html.parser")
                        results = soup.find(attrs={'class': 'yt-uix-tile-link'})
                        wN.sendVideoWithURL(msg.to,'https://www.youtube.com' + results['href'])
                    except:
                        wN.sendText(msg.to, "Could not find it")                    
                ...
                wN.sendAudio(msg.to,"hasil.mp3")
                    ...
                    beb = "Hi Sayang 😘 " +wN.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
                    wN.sendText(msg.to,beb)



            elif "playstore " in msg.text.lower():
                tob = msg.text.lower().replace("playstore ","")
                wN.sendText(msg.to,"Sedang Mencari...")
                wN.sendText(msg.to,"Title : "+tob+"\nSource : Google Play\nLink : https://play.google.com/store/search?q=" + tob)
                wN.sendText(msg.to,"Tuh Linknya Kak (^_^)")
		...
		if msg.from_ in Creator:
                ...
                middd = "Name : " +wN.getContact(msg.from_).displayName + "\nMid : " +msg.from_
                wN.sendText(msg.to,middd)
                ...
                wait["Simi"] = True
                wN.sendText(msg.to," Simisimi Di Aktifkan")
                
            elif msg.text in ["Simisimi off","Simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                wait["Simi"] = False
                wN.sendText(msg.to,"Simisimi Di Nonaktifkan")
                ...
                wN.sendText(msg.to,"----Dari Indonesia----\n" + "" + kata + "\n\n----Ke Inggris----\n" + "" + result)
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                wN.sendText(msg.to,"----Dari Inggris----\n" + "" + kata + "\n\n----Ke Indonesia----\n" + "" + result)
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                wN.sendText(msg.to,"----Dari Thailand----\n" + "" + kata + "\n\n----Ke Indonesia----\n" + "" + result)                
                ...
                contact = wN.findContactsByUserid(userid)
                msg.contentType = 13
                ...
                if msg.from_ in admin:
                    try:
                        wN.removeAllMessages(op.param2)
                ...
                if msg.from_ in admin:
                    ...
                    if gid == "":
                        wN.sendText(msg.to,"Invalid group id")
                    else:
                        try:
                            wN.findAndAddContactsByMid(msg.from_)
                            wN.inviteIntoGroup(gid,[msg.from_])
                        except:
                            wN.sendText(msg.to,"Mungkin Saya Tidak Di Dalaam Grup Itu")


            elif msg.text in ["Glist"]:
                wN.sendText(msg.to, "Tunggu Sebentar. . .")                    
                gid = wN.getGroupIdsJoined()
                h = ""
                for i in gid:
                ...
                wN.sendText(msg.to, msgs)
                    ...
                    wN.sendText(msg.to,"Itu Dia Linknya. . .")     
                ...
                if msg.from_ in admin:
                    ...
                    if gid in [""," "]:
                        wN.sendText(msg.to,"Grup id tidak valid")
                    else:
                        try:
                            groups = wN.getGroup(gid)
                ...
                if msg.from_ in admin:
                    ...
                    for i in gid:
                        if i is not None:
                            ...
                            break
                    if gid is not None:
                        wN.sendText(msg.to,"Berhasil tolak undangan dari grup " + gid.name)
                    else:
                        wN.sendText(msg.to,"Grup tidak ditemukan")
