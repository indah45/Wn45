...
wN1 = CBW.LINE()
#wN1.login(qr=True)
wN1.login(token="EpaLjYoOEs3EMgcuc5G8.1uAIjNn0Al6lg86ClXf9Ya.dQ++4ikf46ktcom51cZLZaZsED9kPbGxtmumBPgDU94=")#1
wN1.loginResult()

wN2 = CBW.LINE()
#wN2.login(qr=True)
wN2.login(token="EpY7brOnrDAKdDvuAU9f.IoDAMDiyLjtmaSKHNfAzxW.vV232eJ9fK5scQ68jnRpj2h/1yB+9NHBf22xmYUn+HA=")#2
wN2.loginResult()

wN3 = CBW.LINE()
#wN3.login(qr=True)
wN3.login(token="Ep8BkAsDKwp9EzxcbWgf.LxQf3n4J+lan9MzgEjTIpW.ic4kX8a5xkeYTR0wpRMXLYKBc9Ukb1OvEpUseUETxsg=")#3
wN3.loginResult()

wN4 = CBW.LINE()
#wN4.login(qr=True)
wN4.login(token="EpE5P9HJPWorNwu1I5Y1.hICAsHWiPbwKnTM3M9rcyq.mE/YBr/5Dee+xAo16F5LmitwcvgyciJRneclfSqQlNQ=")#4
wN4.loginResult()

wN5 = CBW.LINE()
#wN5.login(qr=True)
wN5.login(token="Ep6AwuXwxqH13NbMFP59.AlEHjWlxhgV58LvmsjqU2q.hbG19UPTzhFnxN76outDIySfYrWTGWBOgA8xfkSkwGM=")#5
wN5.loginResult()
...
#==============================================================================#
            ...
            elif "3bye" in msg.text:#keluar semua bots
                if msg.from_ in owner:
                    if msg.toType == 2:
                        ginfo = wN1.getGroup(msg.to)
